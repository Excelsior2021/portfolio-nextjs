const projects = [
  {
    ...
    name: "Smash It!",
    description:
      "Performance tracking for table tennis. Inspired by the competitve nature of table tennis during a web development course.",
  ...
  },
  {
    id: "pairs",
    name: "Pairs",
    description: "An interactive card game.",
  ...
  },
  {
    ...
    description:
      "A web application using the Trivia Database API. Developed for a 24 hour hackathon.",
